...
const ignoreuid = {
    'uid:uVluMBl47UZHUPrKFtlZn8pOKR72': 1,
    'uid:t2blNh4QOwN8Qsn8g2wW0Izlt2k2': 1,
    'uid:XR8JpqfuS9PbSJLvTQEZ4Up2wIF2': 1,
    'uid:aSRpWWSYG4YAiABSIrmNIn658tI2': 1,
}
...
const parseall = async (p) => {  try {
    ...
    for (let index = 0; index < doc.length; index++) {
        ...
        if (info.email && !ignoreuid[log.ref.id]) {
//        if (user !== "") {
